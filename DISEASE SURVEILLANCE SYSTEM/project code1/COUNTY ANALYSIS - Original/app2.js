...
$(document).ready(function(){
	$.ajax({
		url: "http://localhost/project code1/COUNTY ANALYSIS - Original/Chartjs/graphdata/COUNTY_kwal/data.php", //http://localhost/projo copy/
		method: "GET",
...
$(document).ready(function(){
    $.ajax({
        url: "http://localhost/project code1/COUNTY ANALYSIS - Original/Chartjs/graphdata/COUNTY_kwal/data2.php",
        method: "GET",
        success: function(data) {
            console.log(data);
            var Temperature = [];
...
$(document).ready(function(){
    $.ajax({
        url: "http://localhost/project code1/COUNTY ANALYSIS - Original/Chartjs/graphdata/COUNTY_kwal/data3.php",
        method: "GET",
        success: function(data) {
            console.log(data);
            var Period_Startl = [];
...
$(document).ready(function(){
    $.ajax({
        url: "http://localhost/project code1/COUNTY ANALYSIS - Original/Chartjs/graphdata/COUNTY_kwal/data4.php",
        method: "GET",
        success: function(data) {
            console.log(data);
            var Period_Startm = [];
...
$(document).ready(function(){
    $.ajax({
        url: "http://localhost/project code1/COUNTY ANALYSIS - Original/Chartjs/graphdata/COUNTY_kwal/data5.php",
        method: "GET",
        success: function(data) {
            console.log(data);
            var CName = [];
