...
$(document).ready(function(){
	$.ajax({
		url: "http://localhost/project code1/COUNTY ANALYSIS - Original/Chartjs/graphdata/COUNTY_vhg/data.php", //http://localhost/projo copy/
		method: "GET",
...
$(document).ready(function(){
    $.ajax({
        url: "http://localhost/project code1/COUNTY ANALYSIS - Original/Chartjs/graphdata/COUNTY_vhg/data2.php",
        method: "GET",
        success: function(data) {
            console.log(data);
            var Temperature = [];
...
$(document).ready(function(){
    $.ajax({
        url: "http://localhost/project code1/COUNTY ANALYSIS - Original/Chartjs/graphdata/COUNTY_vhg/data3.php",
        method: "GET",
        success: function(data) {
            console.log(data);
            var Period_Startl = [];
...
$(document).ready(function(){
    $.ajax({
        url: "http://localhost/project code1/COUNTY ANALYSIS - Original/Chartjs/graphdata/COUNTY_vhg/data4.php",
        method: "GET",
        success: function(data) {
            console.log(data);
            var Period_Startm = [];
...
$(document).ready(function(){
    $.ajax({
        url: "http://localhost/project code1/COUNTY ANALYSIS - Original/Chartjs/graphdata/COUNTY_vhg/data5.php",
        method: "GET",
        success: function(data) {
            console.log(data);
            var CName = [];
