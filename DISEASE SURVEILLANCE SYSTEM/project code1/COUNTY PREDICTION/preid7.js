...
$(document).ready(function(){
    $.ajax({
        url: "http://localhost/project code1/COUNTY PREDICTION/Chartjs/graphdata/COUNTY_KAJ/data.php", //http://localhost/projo copy/
        method: "GET",
...
$(document).ready(function(){
    $.ajax({
        url: "http://localhost/project code1/COUNTY PREDICTION/Chartjs/graphdata/COUNTY_KAJ/data2.php", //http://localhost/projo copy/
        method: "GET",
        success: function(data) {
            console.log(data);
            var month = [];
